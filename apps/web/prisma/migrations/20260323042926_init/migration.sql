-- CreateEnum
CREATE TYPE "SkinType" AS ENUM ('DRY', 'OILY', 'COMBINATION', 'SENSITIVE', 'NORMAL');

-- CreateEnum
CREATE TYPE "AnalysisType" AS ENUM ('SINGLE', 'ROUTINE');
...
-- CreateIndex
CREATE INDEX "analysis_history_user_id_created_at_idx" ON "analysis_history"("user_id", "created_at" DESC);
