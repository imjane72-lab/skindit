      ...
      <div className="mb-5 grid grid-cols-1 gap-4">
        ...
        {rRes.conflicts && rRes.conflicts.length > 0 && (
          <div className="rounded-2xl border border-rose-200 bg-rose-50 p-5 shadow-sm">
            <div className="mb-3 flex items-center gap-2.5 border-b border-rose-200 pb-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-linear-to-br from-rose-500 to-[#9bce26] shadow-sm">
        ...
        {rRes.timeline && rRes.timeline.length > 0 && (
          <div className="rounded-2xl border border-lime-200 bg-lime-50 p-5 shadow-sm">
            <div className="mb-4 flex items-center gap-2.5 border-b border-lime-200 pb-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#9bce26]">
                  {t(
                    "아침/저녁 사용 추천",
                  ...
                  {rRes.timeline
                    ...
                    .map((ti, i) => (
                      ...
                      >
                        ...
                        {ti.timing === "both" && (
                          <span className="mt-1 inline-block rounded bg-lime-100 px-1.5 py-0.5 text-[9px] font-bold text-lime-700">
                            {t("아침/저녁", "AM/PM")}
                          </span>
                        )}
                      </div>
