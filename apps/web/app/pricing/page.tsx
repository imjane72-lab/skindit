    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-160 mx-auto bg-white min-h-screen shadow-xl relative overflow-hidden">
        ...
        <div className="px-6 py-8 pb-24">
          ...
          {/* Free Card */}
          <div className="rounded-2xl border-2 border-purple-200 bg-linear-to-b from-purple-50/50 to-white p-6 anim-fade-up" style={{ animationDelay: "0.05s" }}>
            <div className="text-center mb-6">
              <span className="inline-block text-[11px] font-bold text-white bg-linear-to-r from-purple-500 to-pink-400 px-3 py-1 rounded-full mb-3">
          ...
          <div className="mt-6 anim-fade-up" style={{ animationDelay: "0.1s" }}>
            <button
              onClick={() => router.push("/")}
              className="w-full h-12 rounded-2xl bg-linear-to-r from-purple-500 via-purple-400 to-pink-400 text-white text-sm font-bold shadow-lg shadow-purple-200/50 hover:shadow-xl transition-all"
            >
