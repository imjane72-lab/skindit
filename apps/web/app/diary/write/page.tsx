    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto min-h-screen max-w-160 bg-white shadow-xl">
        ...
        <div className="px-6 py-8 pb-24">
          ...
          {/* 성분 연동 안내 배너 */}
          <div className="mb-6 rounded-2xl border border-lime-100 bg-linear-to-br from-lime-50/60 to-lime-50/40 p-4 anim-fade-up" style={{ animationDelay: "0.05s" }}>
            <div className="flex items-start gap-3">
              <span className="mt-0.5 text-lg">🧬</span>
              <div>
                <p className="text-xs font-bold text-lime-800 mb-1">{t("성분 분석한 제품은 자동 연동돼!", "Analyzed products auto-link!")}</p>
          ...
          <div className="rounded-2xl border border-lime-100/50 bg-white p-5 space-y-6 shadow-sm anim-scale-in">
            ...
            <div>
              ...
              <div className="relative">
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => addProduct()}
                    className="shrink-0 rounded-xl bg-lime-50 px-4 py-2.5 text-sm font-bold text-lime-700 border border-lime-100 hover:bg-lime-100 transition-all"
                  >
                    추가
                  </button>
                </div>
                    ...
                    {productSuggestions.map(name => {
                      ...
                      return (
                        <button
                          ...
                          className="flex w-full items-center gap-2 border-none bg-transparent px-3 py-2.5 text-left text-sm text-gray-700 hover:bg-lime-50 transition-all"
                        >
                          <span className={`flex h-5 w-5 items-center justify-center rounded-md text-[10px] font-bold ${isAnalyzed ? "bg-lime-100 text-lime-700" : "bg-gray-100 text-gray-500"}`}>
                            {isAnalyzed ? "🧬" : "📝"}
                          </span>
                      ...
                      return (
                        <button
                          ...
                          className={`inline-flex items-center gap-1 rounded-full border px-2.5 py-1.5 text-[11px] font-medium transition-all ${
                            isAnalyzed
                              ? "border-lime-200 bg-lime-50/50 text-lime-700 hover:bg-lime-100"
              ...
              {products.length > 0 && (
                <div className="mt-3 space-y-2">
                  {products.map((p) => {
                    ...
                    return (
                      <div key={p} className={`rounded-xl border p-3 anim-pop-in ${linked ? "border-lime-200 bg-lime-50/30" : "border-gray-100 bg-gray-50/50"}`}>
