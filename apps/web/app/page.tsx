              ...
              <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-purple-50/80 via-white to-pink-50/60 p-5">
                ...
                <div className="relative">
                  ...
                  <div className="flex items-start justify-between gap-0.5">
                    {[
                      { icon: "🔬", label: t("분석", "Analyze"), sub: t("성분 체크~", "Check"), color: "from-blue-100 to-sky-50 border-blue-200" },
                      { icon: "📔", label: t("기록", "Record"), sub: t("매일 기록 📝", "Daily log"), color: "from-pink-100 to-rose-50 border-pink-200" },
                      { icon: "📊", label: t("발견", "Discover"), sub: t("원인 발견 🔍", "Find cause"), color: "from-emerald-100 to-green-50 border-emerald-200" },
                      { icon: "💬", label: t("상담", "Consult"), sub: t("맞춤 솔루션!", "Solution!"), color: "from-purple-100 to-violet-50 border-purple-200" },
                    ].map((step, i) => (
